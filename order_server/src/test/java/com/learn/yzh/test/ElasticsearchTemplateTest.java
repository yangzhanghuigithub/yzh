...
/**
 * @program: yzh->ElasticsearchTemplateTest
 * @description: ElasticsearchTemplateTest
 * @author: yangzhanghui
 * @create: 2019-08-14 19:40
 **/
public class ElasticsearchTemplateTest extends TestConfig {
    @Autowired
