...
import com.learn.yzh.entity.EsEntity;
 ...
 * @description: EsUtil
 * @author: yangzhanghui
 * @create: 2019-08-14 18:44
 **/
@Component
public class EsUtil {

//    @Value("${es.host}")
    public String host = "192.168.0.123";
//    @Value("${es.port}")
...
//        }
     ...
     */
    public void deleteByQuery(String index, MultiMatchQuery.QueryBuilder builder) {
