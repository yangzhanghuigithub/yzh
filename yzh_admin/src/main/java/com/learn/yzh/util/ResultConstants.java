...
public class ResultConstants {
	...
	public static final String MEMBERCODE_CODE_RESULT = "2202"; //用户手机不存在
	/**
	 * 订单成功
	 */
	...
	public static final int ORDER_STATUS_COMPLETED_REFUNDED_SUCCESS = 1501; // 订单成功退款成功
	public static final int ORDER_STATUS_FAILED_REFUNDED_SUCCESS = 1502; // 订单失败退款成功
	public static final int ORDER_STATUS_COMPLETED_REFUNDED_PROGRESE= 1503; // 订单成功退款中
	public static final int ORDER_STATUS_FAILED_REFUNDED_PROGRESE = 1504; // 订单失败退款中

	public static final String MINI_LOGIN_CHANLE = "5";//小程序登录渠道
