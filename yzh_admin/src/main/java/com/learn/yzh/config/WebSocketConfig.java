...
/**
 * @program: yj->WebSocketConfig
 * @description: WebSocketConfigurer
 * @author: yangzhanghui
...
public class WebSocketConfig implements WebSocketConfigurer {
    ...
    public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
        ...
        registry.addHandler(handler, "/myHandler/{ID}").addInterceptors(handshake).setAllowedOrigins("*").withSockJS();;
    }
