...
public class RSAUtils {
	...
	/**
	 * 根据exponent,modulus获取公钥加密后的值
	 * @param privateKeyExponent 私钥exponent
	 * @param privateKeyModulus  私钥 modulus
	 * @param str 公钥加密后值
	 * @return 明文
	 */
	public String decryptRsa(String privateKeyExponent, String privateKeyModulus, String str) {
		RSAPrivateKey rsaPrivateKey = getPrivateKey(privateKeyModulus, privateKeyExponent);
		try {
			return decryptByPrivateKey(str, rsaPrivateKey);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
	...
	public String decryptRsa(String str) {
		String privateKeyExponent = PlatformProperties.getProperty("privateKey_exponent");
		String privateKeyModulus = PlatformProperties.getProperty("privateKey_modulus");
		return decryptRsa(privateKeyExponent, privateKeyModulus, str);
	}
