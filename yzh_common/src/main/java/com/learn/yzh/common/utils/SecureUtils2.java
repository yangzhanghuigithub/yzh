...
public class SecureUtils2 {
	 ...
	 * @return
	 */
	public static String serverEncrypt(String clientChannelCode, String clientVersion, String clientInterfaceName, String clientTimestamp, String clientParameters) {
		System.out.println("--------------- 服务器端加密 start -----------------");
		System.out.println("clientParameters = " + clientParameters);
		
		JSONObject paramJSONObject = new JSONObject();
		
		String unsigned = "api" + clientInterfaceName + "channelCode" + CHANNEL_CODE + "data" + clientParameters + "timestamp" + clientTimestamp + "version" + VERSION + SECRET_KEY;
		System.out.println("unsigned = " + unsigned);
		...
		String url = PREFIX_URL + "?api=" + clientInterfaceName + "&channelCode=" + clientChannelCode + "&data=" + paramTemp + "&timestamp=" + clientTimestamp + "&version=" + clientVersion + "&sign=" + signature;
		System.out.println("url = " + url);
	...
	public static String decode(String source) {
		...
		String serverSignature = serverEncrypt(clientChannelCode, clientVersion, clientInterfaceName, clientTimestamp, clientParameters);
